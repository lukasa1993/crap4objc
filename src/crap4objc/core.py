...
LANGUAGE = 'objc'
PARSER_BY_EXTENSION = {}
DISPLAY_LANGUAGE = 'Objective-C'
EXTENSIONS = ('.m', '.mm', '.h')
FUNCTION_TYPES = frozenset(('function_definition', 'method_definition'))
...
TEST_DIRS = frozenset(('Tests', 'tests', 'test'))
TEST_SUFFIXES = ('Tests.m', 'Tests.mm', 'Test.m', 'Test.mm')
