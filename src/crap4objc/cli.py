...
def parser() -> argparse.ArgumentParser:
    value = argparse.ArgumentParser(description='Calculate strict CRAP scores for Objective-C functions.')
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        if not args.no_test:
            ...
            report = _resolve_swift_report(completed.stdout or "", coverage) if 'objc' == "swift" else discover_coverage_report(coverage)
